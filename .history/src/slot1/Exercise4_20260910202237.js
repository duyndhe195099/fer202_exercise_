...
const Exercise4 = () => {
  ...
  // KHAI BÁO BIẾN Ở ĐÂY ĐỂ CẢ COMPONENT CÙNG DÙNG ĐƯỢC
  const companies = [
  ...
  useEffect(() => {
    ...
    console.log("7. Companies started after 1987:", companies.filter(comp => comp.start > 1987));
    console.log("8. Companies sorted by end date:", [...companies].sort((a, b) => a.end - b.end));
    console.log("9. Ages sorted descending:", [...ages].sort((a, b) => b - a));
    console.log("10. Total sum of ages:", ages.reduce((acc, age) => acc + age, 0));
    ...
    // --- 7. TEST OOP CLASSES (Khởi tạo Triangle để hết cảnh báo unused) ---
  ...
  // Lọc dữ liệu Retail an toàn vì companies đã được định nghĩa ở phạm vi component
